# -*- coding: utf-8 -*-
"""
Baseline YOLO26 object detection benchmark for adenovirus in TEM images.

This script trains the baseline YOLO26n/s/m/l/x object detection model variants 
